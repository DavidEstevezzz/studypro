...
Las preguntas se mantienen en inglés. La práctica predeterminada y los simulacros usan 823 preguntas contrastadas, incluidas 70 nuevas y 241 reformuladas/corregidas. El simulacro distribuye 100 preguntas con pesos 31/20/18/21/10 y 115 minutos. El 31% engloba arquitectura y funcionalidades, no solo IA.

Ya no quedan preguntas pendientes: la práctica ampliada no añade nada sobre la predeterminada. Otras 360 quedan apartadas para revisión y 299 archivadas; no se eliminan del original. Estos estados no equivalen a afirmar que todas las apartadas sean falsas. La revisión documental del banco completo sigue pendiente.
...
Última tanda: [primera tanda de apartadas](audit/quarantine-900-report.md), con decisiones y referencias por ID. Las pendientes están cerradas; quedan 360 apartadas por revisar.
