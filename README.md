...
Las preguntas se mantienen en inglés. La práctica predeterminada y los simulacros usan 509 preguntas contrastadas, incluidas 70 nuevas y 146 reformuladas/corregidas. El simulacro distribuye 100 preguntas con pesos 31/20/18/21/10 y 115 minutos. El 31% engloba arquitectura y funcionalidades, no solo IA.

La práctica adicional permite incluir 491 preguntas pendientes con aviso. Otras 454 quedan apartadas para revisión y 28 archivadas; no se eliminan del original. Estos estados no equivalen a afirmar que todas las apartadas sean falsas. La revisión documental del banco completo sigue pendiente.
...
Para actualizar el banco, editar `scripts/reviewed-questions.mjs` o `scripts/new-questions.mjs`, regenerar y comprobar:
...
Última tanda: [tercera tanda de 100 preguntas revisadas](audit/batch-300-report.md), con decisiones y referencias por ID.
