...
Las preguntas se mantienen en inglés. La práctica predeterminada y los simulacros usan 722 preguntas contrastadas, incluidas 70 nuevas y 220 reformuladas/corregidas. El simulacro distribuye 100 preguntas con pesos 31/20/18/21/10 y 115 minutos. El 31% engloba arquitectura y funcionalidades, no solo IA.

La práctica adicional permite incluir 91 preguntas pendientes con aviso. Otras 455 quedan apartadas para revisión y 214 archivadas; no se eliminan del original. Estos estados no equivalen a afirmar que todas las apartadas sean falsas. La revisión documental del banco completo sigue pendiente.
...
Última tanda: [séptima tanda de 100 preguntas revisadas](audit/batch-700-report.md), con decisiones y referencias por ID.
